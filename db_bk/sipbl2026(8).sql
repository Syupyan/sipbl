...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2023 at 09:02 AM
...
(1, 1, 'Vocuher', 'Barang', 100000, 2, 200000),
(2, 2, 'Baju', 'barang', 500000, 2, 1000000),
(4, 4, 'udin', 'manusia', 10, 1, 10),
(5, 5, 'motor', 'barang', 5000000, 2, 10000000);
...
(2, 'Mahasiswa TI 2', 230130002, '2023-01-06', 1, 2, 'Laki-laki', '123'),
(3, 'Mahasiswa Ti 3', 230130002, '2023-01-12', 1, 3, 'Laki-laki', '123'),
(4, 'Mahasiswa Ti 4', 230130004, '2023-01-11', 1, 3, 'Laki-laki', '123'),
(5, 'Mahasiswa Ti 5', 230130002, '2023-01-13', 1, 3, 'Laki-laki', '123'),
(6, 'Mahasiswa Ti 6', 230130002, '2023-01-11', 1, 3, 'Laki-laki', '123'),
(7, 'Mahasiswa Ti 7', 230130007, '2023-01-11', 1, 3, 'Laki-laki', '123'),
(8, 'Mahasiswa Ti 8', 230130008, '2023-01-05', 1, 3, 'Laki-laki', '123'),
(9, 'Mahasiswa Ti 9', 230130009, '2023-01-05', 1, 3, 'Laki-laki', '123'),
(10, 'Mahasiswa Ti 10', 230130010, '2023-01-11', 1, 3, 'Laki-laki', '123'),
(11, 'Mahasiswa Ti 11', 230130011, '2023-01-05', 1, 3, 'Laki-laki', '123'),
(12, 'Mahasiswa Ti 12', 230130012, '2023-01-04', 1, 4, 'Laki-laki', '123');
...
(1, 'Mata Kuliah 1 TI', 3, 2022, 'semester 1', 1, 4),
(2, 'Mata Kuliah 2 TI', 4, 2022, 'semester 4', 1, 4);
...
(2, 2, '50', 'desain', '2023-01-10', '2023-01-28', '', 'Selesai'),
(3, 2, '51', 'coding', '2023-01-19', '2023-01-31', '', 'Selesai'),
(4, 4, '100', 'desain', '2023-01-11', '2023-01-31', 'bagus', 'Selesai'),
(5, 5, '100', 'desain', '2023-01-12', '2023-01-20', 'bagus', 'Selesai'),
(6, 1, '100', 'hal', '2023-01-18', '2023-01-13', '', 'Belum ada');
...
(1, 'Sistem Informasi PBL(Problem Based Learning)', '2023-01-06 11:56:51', '<p>123</p>\r\n', '123', 'Syupyan1', 1, 59, 63, 59, 59, 'Diterima oleh Reviewer', 1, '06-01-2023', '2023-01-07', '59488f803895852ba51446c3f7520459.pdf', '123'),
(2, 'Bacakan', '2023-01-09 03:29:03', '<p>123</p>\r\n', '123', 'Syupyan1', 1, 59, 59, 59, 59, 'Diterima oleh Reviewer', 1, '09-01-2023', '2023-01-09', '84990903e9c5062788b56619c46c41b4.pdf', '123'),
(3, 'Pembangunan Rancangan', '2023-01-10 02:27:19', '<p>proyek harus terbaik13</p>\r\n', 'Kompeten web', 'pengusul TI', 1, 62, 63, 64, 65, 'Diterima oleh Reviewer', 1, '10-01-2023', '2023-01-11', '2ba8ab96a6a2b01ce0a542a5ccec4dcf.pdf', 'bagus proyek'),
(4, 'Aplikasi pembangunan', '2023-01-10 05:54:19', '<p>123</p>\r\n', '123', 'pengusul TI', 1, 62, 63, 64, 65, 'Diterima oleh Reviewer', 1, '10-01-2023', '2023-01-10', 'b011a59bfd367c2e5a04d3cc82b37c1c.pdf', '123'),
(5, 'Udin sedunia', '2023-01-12 03:09:40', '<p>123</p>\r\n', '123', 'Syupyan1', 0, 59, 59, 0, 0, 'Menunggu Tinjauan Proyek', 1, '12-01-2023', '2023-01-11', '7847a4600984ef7b57d74028da826b7f.pdf', 'guuud');
...
(1, 1, 'Realiasasi Waktu Pengerjaan Proyek', 'y', 'Sesuai'),
(2, 1, 'Kesesuaian dengan spesifikasi dalam rencana pelaksanaan PBL', 'y', 'Sesuai'),
(3, 1, 'Jumlah Produk', 'y', 'Sesuai'),
(4, 1, 'Keberfungsian / Kelaikan penggunaan', 'y', 'Sesuai'),
(5, 3, 'Realiasasi Waktu Pengerjaan Proyek', 'bagus', 'Sesuai'),
(6, 3, 'Kesesuaian dengan spesifikasi dalam rencana pelaksanaan PBL', 'bagus', 'Sesuai'),
(7, 3, 'Jumlah Produk', 'tidak', 'Tidak Sesuai'),
(8, 3, 'Keberfungsian / Kelaikan penggunaan', 'bagus', 'Sesuai'),
(9, 4, 'Realiasasi Waktu Pengerjaan Proyek', 'bagus', 'Sesuai'),
(10, 4, 'Kesesuaian dengan spesifikasi dalam rencana pelaksanaan PBL', 'bagus', 'Sesuai'),
(11, 4, 'Jumlah Produk', 'bagus', 'Sesuai'),
(12, 4, 'Keberfungsian / Kelaikan penggunaan', 'bagus', 'Sesuai');
...
(1, 1, 'Baju', 200000, 'Harga', 'g', 'Diterima', '06-01-2023'),
(5, 4, 'Politeknik Negeri Tanah Laut', 10000000, 'udin', 'terimaaaa', 'Diterima', '11-01-2023');
...
(4, 'Gedung A', 'Ruang12', '<p>Ruangan Fasilitas:</p>\r\n\r\n<p>1. Mobil</p>\r\n');
...
--
ALTER TABLE `tbl_akses_menu`
  MODIFY `id_akses_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=281;
...
--
ALTER TABLE `tbl_rpp`
  MODIFY `id_rpp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
