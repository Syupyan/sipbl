...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2023 at 06:19 AM
...
--
ALTER TABLE `tbl_proyek`
  ADD CONSTRAINT `r_pengusul` FOREIGN KEY (`pengguna_id_pengusul`) REFERENCES `tbl_pengguna` (`id_pengguna`) ON UPDATE CASCADE;
COMMIT;
