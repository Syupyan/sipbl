...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2023 at 02:25 AM
...
(29, 'mhs 1', 23, '2022-12-28', 1, 23, 'Laki-laki', '123'),
(30, 'mhs 2', 2001301157, '2022-12-29', 1, 24, 'Laki-laki', '123');
...
(32, 3, '100', 'desain', '2022-12-28', '2022-12-31', 'gg bro', 'Selesai');
...
(23, 'wwwwwwwww', '2022-12-28 05:52:26', '<p>123</p>\r\n', '123', 'Syupyan1', 1, 59, 59, 59, 59, 'Diterima oleh Reviewer', 12, '28-12-2022', '2022-12-29', '601c2eb054352495a831e6b5898cf053.pdf', 'keren'),
(24, 'Pembangunan Rancangan', '2022-12-29 00:50:20', '<p>123</p>\r\n', '123', 'Syupyan1', 1, 59, 59, 59, 59, 'Diterima oleh Reviewer', 12, '29-12-2022', '2023-02-28', '7dc560206f082b637bdfee75fdb8a9d5.pdf', 'Bagus sudah');
...
(9, 23, 'Realiasasi Waktu Pengerjaan Proyek', 'jelek', 'Tidak Sesuai'),
(10, 23, 'Kesesuaian dengan spesifikasi dalam rencana pelaksanaan PBL', 'ampas', 'Tidak Sesuai'),
(11, 23, 'Jumlah Produk', 'g guna', 'Tidak Sesuai'),
(12, 23, 'Keberfungsian / Kelaikan penggunaan', 'g jelas', 'Tidak Sesuai');
...
(3, 23, 'Desain', 100000, 'keren', 'hore', 'Diterima', '28-12-2022');
...
--
ALTER TABLE `tbl_akses_menu`
  MODIFY `id_akses_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=271;
...
--
ALTER TABLE `tbl_monitoring`
  MODIFY `id_monitoring` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `tbl_rpp`
  MODIFY `id_rpp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
