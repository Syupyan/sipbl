      ...
      <section class="content">
          <div class="container-fluid">
              ...
              <div class="card">
                  ...
                  <div class="col-sm-2">
	<select class="form-control filterprodi" name="">
							<option readonly>-- Filter Data Proyek --</option>
							<option value="">* Tampilkan Semua</option>
                            <?php foreach ($get_prodi as $prodi): ?>
              <option value="<?= $prodi['prodi_nama'] ?>">* <?= $prodi['prodi_nama'] ?> [<?= $prodi['prodi_alias'] ?>]</option>
            <?php endforeach; ?>
						</select>
					</div>
					</div>
...
->where('pengguna_id_manajer_proyek !=',0)
->where('pengguna_id_cpo !=',0)
->get()->result();
?>
                              ...
                              <tr>
                                  ...
                                  <td>
                                  <a  title="Kelola Proyek" href="<?= base_url('direktur/kelola-proyek/' .$proyek->id_proyek); ?>"><button class="btn btn-primary"><i class="fa fa-tasks"></i></button></a>
                                  </td>
                              </tr>
                              <?php $no++;
                                    } ?>
