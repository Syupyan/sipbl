...
//  buatkan query perhitungan total 
    ...
    <?php if($total >= 100){ ?>
                        <?php 
                        // query builder count menggunakan filter proyek id
                        $this->db->select('COUNT(*) as total');
                        $this->db->from('tbl_quality_control');
                        $this->db->where('proyek_id',$proyek->id_proyek);
                        $query = $this->db->get();
                        $result = $query->row();
                        ?>
                        <?php
                        // buatkan if menggunakan query builder di atas
                        if ($result->total < 4) {
                        ?>
                         <button class="btn btn-primary" data-toggle="modal" data-target="#modal-tambah-qc"><i
                     ...
                     <table class="table table-bordered">
                         ...
                         <tbody>
                             ...
                             <input type="hidden" value="<?= $proyek->id_proyek ?>" required="" name="id_proyek[]"
                                 ...
                                 <td><textarea readonly class="form-control" type="text" name="qc_kesesuaian_rencana[]"
                                         value="Keberfungsian / Kelayakan penggunaan">Keberfungsian / Kelayakan penggunaan</textarea></td>
                                 <td><textarea class="form-control" name="qc_catatan[]"></textarea></td>
                             </tr>
              ...
              <div class="modal-body">
                  <div class="form-group">
                      <i>
                          <b>Perhatian!</b> <br>
                          <ul>
                          <li>Tambah quality control akan tampil ketika monitoring selesai dilaksanakan pada bobot 100%.</li>
                          </ul>
                      </i>
                  </div>
              </div>
