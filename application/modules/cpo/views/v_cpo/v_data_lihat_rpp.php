          ...
          <div class="container-fluid">
             ...
             <div class="card">
                 <div class="card-header">
                     <h3 class="card-title">Balas Ajukan RPP</h3>
                ...
                <button title="Informasi" class="btn btn-warning" data-toggle="modal" data-target="#modal-informasi"><i class="fas fa-fw fa-info"></i></button>
                 ...
                 <div class="card-body table-responsive">
                     ...
                     <form method="post" enctype="multipart/form-data"
                             action="<?= base_url('cpo/Data_Kelola_Cpo/cpo_rpp') ?>">
                     <input required="" value="<?= $proyek->id_proyek ?>" name="id_proyek" type="hidden"
                         ...
                         <tr>
                             ...
                             <td>
                                 <input readonly value="<?= $proyek->rpp_sponsor ?>" name="rpp_sponsor" type="text" class="form-control" size="70"></input>
                             </td>
                         </tr>
                         <tr>
                             <td width=190 class="text-bold">Biaya</td>
                             <td>
                                 <input readonly value="<?= $proyek->rpp_biaya_proyek ?>" name="rpp_biaya_proyek" type="text" class="form-control" size="70"></input>
                             </td>
                         </tr>
                         <tr>
                             <td width=190 class="text-bold">Klien</td>
                             <td>
                                 <input readonly value="<?= $proyek->rpp_klien ?>" name="rpp_klien" type="text" class="form-control" size="70"></input>
                             </td>
                         </tr>
                         <tr>
                             <td width=190 class="text-bold">Tanggal Waktu Pengajuan</td>
                             <td>
                                 <input value="<?= $proyek->rpp_waktu ?>" readonly name="rpp_waktu" type="text" class="form-control" size="70"
                                     required></input>
                             </td>
                         </tr>
                         <?php if($proyek->rpp_status == "Diterima" || $proyek->rpp_status == "Revisi"){ ?>
                            <tr>
                             <td width=190 class="text-bold">Komentar</td>
                             <td>
                             <textarea readonly name="rpp_komentar" required=""
                         ...
                         <tr>
                             ...
                             <td>
                                <input class="form-control" readonly type="text" value="<?= $proyek->rpp_status ?>"></input>
                             </td>
                         </tr>
                            <?php }else{ ?>
                        <tr>
                             <td width=190 class="text-bold">Komentar</td>
                             <td>
                             <textarea name="rpp_komentar" required=""
                                         class="form-control"><?= $proyek->rpp_komentar ?></textarea>
                             </td>
                         </tr>
                         <tr>
                             <td width=190 class="text-bold">Status RPP</td>
                             <td>
                                <select name="rpp_status" id="" class="form-control">
...
//  buatkan query perhitungan rpp untuk total
 ...
 ?>
        ...
        <td>
            <input disabled type="text" value="Rp. <?php echo $totalku; ?>" class="form-control" size="70"></input>
        </td>
    </tr>
    <tr>
...
//  buatkan query perhitungan rpp untuk total
 ...
 ?>
        ...
        <td>
            <input disabled type="text" value="Rp. <?php echo $totalku1; ?>" class="form-control" size="70"></input>
        </td>
    </tr>
</table>
...
<div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" name="autoSumForm" action="<?= base_url('pm/Data_Kelola_Proyek_Manajer/add_alat_bahan') ?>">
      <div class="modal-body">
      <?php
      foreach($rppku as $rpp){
?>
      <input  type="hidden" value="<?= $rpp->id_rpp ?>" required="" name="rpp_id"  class="form-control"></input>
      ...
      <div class="form-group">
        ...
        <input type="text" name="ab_jumlah" onFocus="startCalc();" onBlur="stopCalc();" class="form-control"></input>
        </div>
        <div class="form-group">
        <label for="">Total</label>
        <input type="text" name="ab_total" onchange="tryNumberFormat(this.form.thirdBox);" class="form-control"></input>
        </div>
      <?= get_csrf() ?>
      <div class="modal-footer">
...
<div class="modal fade" id="modal-edit1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" name="autoSumForm1" action="<?= base_url('pm/Data_Kelola_Proyek_Manajer/edit_alat_bahan') ?>">
      <div class="modal-body">
      <div class="form-group">
      ...
      <input type="hidden" value="<?= $proyek->id_proyek ?>" required="" name="id_proyek" class="form-control"></input>
        ...
        <div class="form-group">
        <label for="">Harga</label>
        <input type="text" id="ab_harga"  name="ab_harga" onFocus="startCalc1();" class="form-control"></input>
        </div>
        <div class="form-group">
        <label for="">Jumlah</label>
        <input type="text" id="ab_jumlah" name="ab_jumlah" onFocus="startCalc1();" onBlur="stopCalc1();" class="form-control"></input>
        </div>
        <div class="form-group">
        <label for="">Total</label>
        <input type="text" id="ab_total" name="ab_total" onchange="tryNumberFormat(this.form.thirdBox);" class="form-control"></input>
        </div>
      <?= get_csrf() ?>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
...
<script type="text/javascript">
  $(document).ready(function() {
    $(".btn-edit1").click(function(){
      ...
      $.get("<?= base_url('pm/Data_Kelola_Proyek_Manajer/show_alat_bahan/') ?>"+id_ab,function(response){
              ...
              <div class="modal-body">
                  <div class="form-group">
                      <i>
                          <b>Perhatian!</b> <br>
                          <ul>
                          <li>Ketika menerima maka input komentar dan status rpp akan disabled</li>
                          </ul>
                      </i>
                  </div>
              </div>
