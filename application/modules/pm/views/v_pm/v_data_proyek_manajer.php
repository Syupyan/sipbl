                      ...
                      <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><?php if ($proyek->proyek_status == 'Diterima oleh Reviewer'): ?>
                                      <center><span class="badge badge-success">Siap Dikerjakan</span>
                                      </center>
                                      <?php endif ?>
                                  </td>
                                  <td>
                                  <a title="Kelola Proyek" href="<?= base_url('pm/kelola-proyek/' .$proyek->id_proyek); ?>"><button class="btn btn-primary"><i class="fa fa-tasks"></i></button></a>
                                  </td>
                              </tr>
                              <?php $no++;
                                    } ?>
