             ...
             <div class="card">
                 ...
                 <div class="card-body table-responsive">
                     <table class='table table-bordered'>
                         <form method="post" action="<?= base_url('pm/Data_Kelola_Proyek_Manajer/add_ajukan') ?>">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <input name="rpp_sponsor" type="text" class="form-control" size="70"></input>
                                 </td>
                             </tr>
                             <tr>
                                 <td width=190 class="text-bold">Biaya</td>
                                 <td>
                                     <input id="rupiah" name="rpp_biaya_proyek" type="text" class="form-control"
                                         size="70"></input>
                                 </td>
                             </tr>
                             <tr>
                                 ...
                                 <td>
                                     <input name="rpp_klien" type="text" class="form-control" size="70"></input>
                                 </td>
                             </tr>
                             <tr>
                                 <td width=190 class="text-bold">Tanggal Waktu Pengajuan</td>
                                 <td>
                                     <input readonly name="rpp_waktu" type="text" class="form-control" size="70"
                                         required value="<?= date("d-m-Y"); ?>"></input>
                                 </td>
                             </tr>
         ...
         <div class="container-fluid">
             ...
             <div class="card">
                 <div class="card-header">
                     ...
                     <div class="float-right">
                         <button title="Informasi" class="btn btn-warning" data-toggle="modal"
                             data-target="#modal-informasi1"><i class="fas fa-fw fa-info"></i></button>
                         <?php foreach($rppku as $r): ?>
                         <?php if($r->rpp_status == "Diterima"): ?>
                         <?php else: ?>
                         <?php
...
$rppku1 = $this->db->select('*')
->from('tbl_monitoring')
->join('tbl_rpp', 'tbl_monitoring.rpp_id=tbl_rpp.id_rpp')
->where('tbl_rpp.proyek_id',$proyek->id_proyek)
->get()->result();
?>
                             <?php $no = 1; foreach($rppku1 as $mt){ ?>
                             <tr>
                                 <td><?= $no ?></td>
         ...
         <div class="container-fluid">
             ...
             <div class="card">
                 <div class="card-header">
                     ...
                     <div class="float-right">
                         <button title="Informasi" class="btn btn-warning" data-toggle="modal"
                             data-target="#modal-informasi2"><i class="fas fa-fw fa-info"></i></button>
                         <?php foreach($rppku as $r): ?>
                         <?php if($r->rpp_status == "Diterima"): ?>
                         <?php else: ?>
                         <?php
...
?>
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" name="ab_harga" onFocus="startCalc();"
                             class="form-control"></input>
                     </div>
                     <div class="form-group">
         ...
         <div class="modal-content">
             ...
             <form method="post" name="autoSumForm1"
                 ...
                 <div class="modal-body">
                     ...
                     <div class="form-group">
                         <label for="">Jumlah</label>
                         <input type="text" id="ab_jumlah" name="ab_jumlah" onFocus="startCalc1();"
                             onBlur="stopCalc1();" class="form-control"></input>
                     </div>
                     <div class="form-group">
                         <label for="">Total</label>
                         <input type="text" id="ab_total" name="ab_total"
                             onchange="tryNumberFormat(this.form.thirdBox);" class="form-control"></input>
                     </div>
                     <?= get_csrf() ?>
                     <div class="modal-footer">
                         <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
     ...
     <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div class="form-group">
                     <ol>
                         <li>Bobot adalah hitungan <i>%</i> pada monitoring, dimana batas bobot adalah 100%, jika
                             melebihi maupun sesuai tombol tambah akan menghilang.</li>
                         <li>Tahapan Pengerjaan adalah hal apa yang akan dilakukaan, untuk monitoring, contohnya
                             <i>Desain</i>.</li>
                     ...
                     <i>
                         <b>Perhatian!</b> <br>
                         <ul>
                             <li>Tombol Tambah <i class="fa  fa-plus" style="color: red"></i> akan menghilang
                                 ketika bobot melebihi atau sesuai dengan 100%</li>
                         </ul>
                     </i>
                 </div>
             </div>
             ...
             <div class="modal-body">
                 <div class="form-group">
                     <i>
                         <b>Perhatian!</b> <br>
                         <ul>
                             <li>Sponsor adalah nama instansi atau perusahaan</li>
                             <li>Klien adalah seseorang yang meminta dibuatkan proyek</li>
                             <li>Tombol tambah <i class="fa  fa-plus" style="color: red"></i> pada data monitoring, alat
                                 dan bahan akan tampil ketika ajukan proyek dikirim,</li>
                         </ul>
                     </i>
                 </div>
             </div>
             ...
             <div class="modal-body">
                 <div class="form-group">
                     ...
                     <i>
                         ...
                         <ul>
                             <li>Tombol Tambah <i class="fa  fa-plus" style="color: red"></i> akan menghilang
                                 ketika total harga melebihi dari modal rpp yang diajukan</li>
                         </ul>
                     </i>
                 </div>
             </div>
